...
class PublicIngredientsApiTest(TestCase):
    """ Test the publicly available ingrediendts API """
...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_ingredients_limited_to_user(self):
        """ Self that ingredients for the authenticated user are returned """
    ...
    def test_retrieved_ingredients_assigned_to_recipes(self):
